          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-2/3 mb-10 md:mb-0">
              ...
              <p className="text-lg mb-10 text-blue-100 max-w-2xl">
                Udaan empowers citizens to report child labour cases and help
                NGOs take action. Every report brings us closer to a world where
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Child labour robs children of their childhood, their potential,
              and their dignity.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                ...
                Early work prevents cognitive development and limits future
                opportunities.
              </p>
            </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className={`${card.bg} p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300`}
              >
                <div className="mb-6">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-teal-50 rounded-3xl p-8 md:p-12 shadow-lg">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  Udaan is a non-profit initiative focused on identifying,
                  reporting, and resolving child labour cases through
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  ...
                  enabling faster response times and more effective
                  interventions.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  ...
                  reporting to resolution with complete transparency and
                  accountability.
                </p>
              </div>
            </div>
            ...
            <div className="mt-12 bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-200">
              <p className="text-gray-700 text-center text-lg leading-relaxed">
                <span className="font-bold text-blue-600">Udaan</span> leverages
                technology to create a collaborative ecosystem where every
                citizen becomes a protector of childhood. Together, we're
                building a future where no child has to work for survival.
              </p>
            </div>
          </div>
        </div>
